...
public class BbsDto implements Serializable {
	...
	public BbsDto(String id, String titie, String content) {
		super();
		this.id = id;
		this.title = title;
	...
	public BbsDto(int seq, String titie, String content) {
		super();
		this.seq = seq;
		this.title = title;
		this.content = content;
	...
	public BbsDto(int seq, String id, int ref, int step, int depth, String titie, String content, String wdate, int del,
			int readcount) {
		super();
		this.seq = seq;
		this.id = id;
